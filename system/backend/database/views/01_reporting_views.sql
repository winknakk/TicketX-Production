...
-- /database/views/01_reporting_views.sql
-- Target Database: PostgreSQL 16+
-- ============================================================

-- 1. ACTIVE INBOX VIEW (Messaging & Support Reporting Read Model)
...
-- 2. TICKET SLA STATUS VIEW (Support Operations SLA Reporting)
